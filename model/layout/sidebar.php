...
<li id="output"></li>
   <?php
   		if (isset($_SESSION['pb'])) {
   			$link=array("","add_siswa","siswa","absen","absensi","req_catatan","catatan", "katasandi&id=$_SESSION[id]", "laporan","keluar");
			$name=array("","Tambah Siswa","Daftar Siswa","Absen","Lihat Absensi","Catatan","Lihat Catatan","Ubah Katasandi","Laporan", "Keluar");
