...
<body>
  ...
  <div class="container">
    <form class="form-signin" method="post" action="model/proses.php">
      <!-- img logo -->
      <!-- div align center -->
      <div class="" style="float: middle; width: 100%; text-align: center;">
        <img src="./lib/img/saung-logo.png" alt="logo" style="width: 100px; height: 100px;">
      </div>
    ...
    <br>
    <center>
      <p>Aplikasi Absensi V1 <a href="https://www.facebook.com/mohammad.defirda" title="v1" target="_blank">Saung IT Bumiayu</a></p>
    </center>
  </div> <!-- /container -->
