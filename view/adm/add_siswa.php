...
<form class="form-horizontal" role="form" style="width:80%" onSubmit="return validasi()" name="formulir" method="post" action="./model/proses.php">
  ...
  <div class="form-group">
    <label class="control-label col-sm-2" for="sekolah">Nama Instansi:</label>
    <div class="col-sm-10">
      <input type="text" class="form-control" name="sklh" placeholder="Masukan Nama Instansi" required>
    </div>
  </div>
  <div class="form-group">
   ...
   <div class="form-group">
    <label class="control-label col-sm-2" for="sosmed">Sosial Media:</label>
    <div class="col-sm-10">
      <input type="text" class="form-control" name="sosmed" placeholder="Masukan Sosial Media" required>
    </div>
  </div>
  <div class="form-group">
  <fieldset>
